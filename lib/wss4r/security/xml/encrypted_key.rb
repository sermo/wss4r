...
class EncryptedKey
   ...
   def unprocess(encrypted_key)
		...
		algorithm = REXML::XPath.first(encrypted_key, "//xenc:EncryptionMethod", {"xenc" => Namespaces::XENC})
		key_info_element = REXML::XPath.first(encrypted_key, "ds:KeyInfo", {"ds"=>Namespaces::DS})
      ...
      @x509security_token = key_info.security_token()
		...
		cipher_value = REXML::XPath.first(encrypted_key, "xenc:CipherData/xenc:CipherValue", {"xenc" => Namespaces::XENC})
