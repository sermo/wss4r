module WSS4R
  module Security
	...
	def unprocess(document)
          ...
          canonicalization_method = REXML::XPath.first(signed_info, Names::CANONICALIZATION_METHOD)
          @canonicalization_method = canonicalization_method.attribute("Algorithm").value()

          signature_method = REXML::XPath.first(signed_info, Names::SIGNATURE_METHOD)
